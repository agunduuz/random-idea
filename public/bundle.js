...
(() => {
  ...
  const R = c('HTMLFormElement'),
    ...
    C = '0123456789',
    F = { DIGIT: C, ALPHA: k, ALPHA_DIGIT: k + k.toUpperCase() + C },
    U = c('AsyncFunction'),
    B = {
      isArray: l,
      isArrayBuffer: d,
      ...
      freezeMethods: (t) => {
        N(t, (e, n) => {
          if (p(t) && -1 !== ['arguments', 'caller', 'callee'].indexOf(n))
            return !1;
          const r = t[n];
          p(r) &&
            ((e.enumerable = !1),
  ...
  const J = B.toFlatObject(B, {}, null, function (t) {
      ...
      function u(t, n, o) {
        ...
        if (t && !o && 'object' == typeof t)
          if (B.endsWith(n, '{}'))
            ...
            (B.isArray(t) &&
              (function (t) {
                return B.isArray(t) && !t.some(z);
              })(t)) ||
            ((B.isFileList(t) || B.endsWith(n, '[]')) && (s = B.toArray(t)))
          )
            return (
              (n = G(n)),
              s.forEach(function (t, r) {
                !B.isUndefined(t) &&
                  null !== t &&
                  e.append(
                    !0 === a ? H([n], r, i) : null === a ? n : n + '[]',
                    c(t)
                  );
              }),
              !1
            );
        return !!z(t) || (e.append(H(o, n, i), c(t)), !1);
      }
      const l = [],
        f = Object.assign(J, {
          defaultVisitor: u,
  ...
  function ct(t) {
    return !1 === t || null == t ? t : B.isArray(t) ? t.map(ct) : String(t);
  }
  ...
  class lt {
    ...
    has(t, e) {
      if ((t = st(t))) {
        const n = B.findKey(this, t);
        return !(!n || void 0 === this[n] || (e && !ut(0, this[n], n, e)));
      }
      return !1;
    }
    delete(t, e) {
      ...
      function o(t) {
        if ((t = st(t))) {
          ...
          !o || (e && !ut(0, n[o], o, e)) || (delete n[o], (r = !0));
        }
      }
    ...
    clear(t) {
      ...
      for (; n--; ) {
        const o = e[n];
        (t && !ut(0, this[o], o, t, !0)) || (delete this[o], (r = !0));
      }
      return r;
    }
    normalize(t) {
    ...
    static accessor(t) {
      const e = (this[at] = this[at] = { accessors: {} }).accessors,
        n = this.prototype;
      function r(t) {
        const r = st(t);
        e[r] ||
  ...
  lt.accessor([
    ...
    B.reduceDescriptors(lt.prototype, ({ value: t }, e) => {
  ...
  B.inherits(pt, M, { __CANCEL__: !0 });
  const mt = pt,
    yt = et.isStandardBrowserEnv
      ? {
  ...
  const gt = et.isStandardBrowserEnv
    ? (function () {
    ...
    xhr:
      ...
      function (t) {
        return new Promise(function (e, n) {
          let r = t.data;
          const o = ft.from(t.headers).normalize(),
            i = t.responseType;
          let a;
          function s() {
          ...
          if (
            ...
            (c.onabort = function () {
              c &&
                (n(new M('Request aborted', M.ECONNABORTED, t, c)), (c = null));
            }),
            (c.onerror = function () {
          ...
          void 0 === r && o.setContentType(null),
            ...
            'function' == typeof t.onDownloadProgress &&
              c.addEventListener('progress', bt(t.onDownloadProgress, !0)),
            'function' == typeof t.onUploadProgress &&
              c.upload &&
              c.upload.addEventListener('progress', bt(t.onUploadProgress)),
            (t.cancelToken || t.signal) &&
              ((a = (e) => {
                c &&
                  (n(!e || e.type ? new mt(null, t, c) : e),
                  c.abort(),
                  (c = null));
              }),
          ...
          f && -1 === et.protocols.indexOf(f)
            ? n(new M('Unsupported protocol ' + f + ':', M.ERR_BAD_REQUEST, t))
            : c.send(r || null);
        });
      },
  };
  ...
  const Et = (t) => {
    ...
    for (
      let o = 0;
      o < e && ((n = t[o]), !(r = B.isString(n) ? wt[n.toLowerCase()] : n));
      o++
    );
    if (!r) {
      if (!1 === r)
  ...
  function Ot(t) {
    return (
      ...
      Et(t.adapter || ot.adapter)(t).then(
        function (e) {
          return (
            St(t),
  ...
  const xt = (t) => (t instanceof ft ? t.toJSON() : t);
  function _t(t, e) {
    e = e || {};
    const n = {};
    function r(t, e, n) {
  ...
  class Pt {
    ...
    request(t, e) {
      ...
      let i = o && B.merge(o.common, o[e.method]);
      o &&
        B.forEach(
  ...
  B.forEach(['delete', 'get', 'head', 'options'], function (t) {
    ...
    B.forEach(['post', 'put', 'patch'], function (t) {
      ...
      (Pt.prototype[t] = e()), (Pt.prototype[t + 'Form'] = e(!0));
    });
  const At = Pt;
  class Nt {
    constructor(t) {
      ...
      this.promise.then((t) => {
        ...
        t(function (t, r, o) {
          n.reason || ((n.reason = new mt(t, r, o)), e(n.reason));
        });
    }
    throwIfRequested() {
  ...
  const Ft = Ct,
    Ut = (function t(e) {
      const n = new At(e),
        o = r(At.prototype.request, n);
      return (
        B.extend(o, At.prototype, n, { allOwnKeys: !0 }),
      ...
      (n = [
        {
          key: 'getIdeas',
          value: function () {
            return Bt.get(this._apiUrl);
          },
        },
        {
          key: 'createIdea',
          value: function (t) {
            return Bt.post(this._apiUrl, t);
          },
        },
        {
          key: 'updateIdea',
          value: function (t, e) {
            return Bt.put(''.concat(this._apiUrl, '/').concat(t), e);
          },
        },
        {
          key: 'deleteIdea',
          value: function (t) {
            var e = localStorage.getItem('username')
              ...
              : 'anonymous';
            return Bt.delete(''.concat(this._apiUrl, '/').concat(t), {
              data: { username: e },
            });
          },
        },
    ...
    function w(t, e) {
      function o(r, i, a, s) {
        ...
        if ('throw' !== c.type) {
          var u = c.arg,
            f = u.value;
          return f && 'object' == Mt(f) && n.call(f, '__await')
          ...
          value: function () {
            ...
            this._ideaListEl.addEventListener('click', function (e) {
              if (e.target.classList.contains('fa-times')) {
                ...
                var n = e.target.parentElement.parentElement.dataset.id;
                t.deleteIdea(n);
              }
            });
          },
                  ...
                  function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (t.prev = 0), (t.next = 3), qt.getIdeas();
                        case 3:
                          (e = t.sent),
                ...
                return zt().wrap(
                  function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (t.prev = 0), (t.next = 3), qt.deleteIdea(e);
                        case 3:
                          t.sent,
    ...
    function w(t, e) {
      function o(r, i, a, s) {
        ...
        if ('throw' !== c.type) {
          var u = c.arg,
            f = u.value;
          return f && 'object' == Kt(f) && n.call(f, '__await')
            ? e.resolve(f.__await).then(
                function (t) {
                  o('next', t, a, s);
                },
                ...
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 8:
                        (r = t.sent),
                          this._ideaList.addIdeaToList(r.data.data),
                          (this._form.elements.text.value = ''),
                          (this._form.elements.tag.value = ''),
                          (this._form.elements.username.value = ''),
                          this.render(),
